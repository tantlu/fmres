...
type Category = 'All' | 'FM Version' | 'Face' | 'Logo' | 'Database' | 'Việt hóa' | 'Mods' | 'Tactics' | 'Guide' | 'Kits';
...
const CATEGORIES: Category[] = ['All', 'FM Version', 'Face', 'Logo', 'Database', 'Việt hóa', 'Tactics', 'Mods', 'Guide', 'Kits'];
...
export default function App() {
  ...
  return (
    ...
    <img
      src="https://yt3.ggpht.com/83WfPjeUQMeiK56shkZPb4opoo8vqdP9PpSpf92ayYAUIEocv8GbRvze_tjZumiBAsK0sVWVUQ=s600-c-k-c0x00ffffff-no-rj-rp-mo"
      alt="FM Res Hub Logo"
      className="w-10 h-10 md:w-12 md:h-12 bg-[#1e293b] rounded-lg shadow-lg shadow-emerald-900/50 group-hover:scale-105 transition-transform overflow-hidden block mx-auto mb-4"
    />
